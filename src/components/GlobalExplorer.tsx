            ...
            {filteredIssues.map((issue) => (
              ...
              >
                ...
                <div className="p-5 flex-grow flex flex-col">
                  ...
                  <a href={issue.url} target="_blank" rel="noreferrer" className="flex-grow flex flex-col cursor-pointer group/link">
                    {/* Title */}
                    <h3 className="text-sm font-bold text-text-primary mb-2 line-clamp-2 group-hover/link:text-brand-purple transition-colors">
                      {issue.title}
                    </h3>
