        ...
        <div className="text-center space-y-8 max-w-4xl mx-auto">
          ...
          >
            <Link
              ...
              className="flex items-center space-x-3 px-8 py-4 rounded-xl bg-white text-black hover:bg-gray-200 text-base font-bold transition-all shadow-lg hover:scale-105 duration-200"
            >
